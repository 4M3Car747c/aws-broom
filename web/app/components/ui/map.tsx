...
// Self-host the MapLibre worker (mapcn defaults to unpkg). `?worker&url` makes
// Vite bundle the worker together with the chunks it imports and hand back the
// URL, so the app has no runtime CDN dependency and no unresolved imports.
